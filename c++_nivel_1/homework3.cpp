...
int main() {
    int talla, cantidad, costo, precio, costo_total, precio_total, utilidad_unidad, utilidad_total;
    char referencia[30], descripcion[100], disponibilidad, tipo;
    ...
    // Clasifición de zapatos según su costo	
    if (costo <= 30000) {
        tipo = 'A';
